    ...
    public ItemCasing(CASING_SIZE size)
    {
        ...
        switch (size)
        {
            case CASING_SIZE.SMALL:
                ...
                this.icon = Resources.Load<Sprite>("Assets/Sprites/Items/casing_small");
            ...
            case CASING_SIZE.MEDIUM:
                ...
                this.icon = Resources.Load<Sprite>("Assets/Sprites/Items/casing_med");
            ...
            case CASING_SIZE.LARGE:
                ...
                this.icon = Resources.Load<Sprite>("Assets/Sprites/Items/casing_large");
